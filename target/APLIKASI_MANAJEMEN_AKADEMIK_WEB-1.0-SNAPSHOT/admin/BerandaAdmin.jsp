...
<body>
  <div class="sidebar">
    <div>
      ...
      <nav>
        ...
        <a href="#" class="nav-item"><i class="fa-solid fa-calendar-days"></i> Managemen Jadwal</a>
        <a href="#" class="nav-item"><i class="fa-solid fa-user-graduate"></i> Managemen Siswa</a>
        <a href="#" class="nav-item"><i class="fa-solid fa-user-tie"></i> Manajemen Guru</a>
  ...
  <div class="main">
    <div class="header">
      ...
      <div class="user"><i class="fa-solid fa-user"></i> Mang Atmin</div>
    </div>
    <div class="content">
      <div class="card"></div>
    </div>
