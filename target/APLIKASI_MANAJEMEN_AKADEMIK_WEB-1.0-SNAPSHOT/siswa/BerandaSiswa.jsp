  ...
  <div class="sidebar">
    <div>
      ...
      <nav>
        ...
        <a href="#" class="nav-item"><i class="fa-solid fa-calendar-days"></i> Jadwal Pelajaran</a>
        <a href="#" class="nav-item"><i class="fa-solid fa-star"></i> Nilai</a>
        <a href="#" class="nav-item"><i class="fa-solid fa-clipboard-user"></i> Absensi</a>
        <a href="#" class="nav-item" style="opacity: 0.5; pointer-events: none;"><i class="fa-solid fa-lock"></i> Administrasi akademik</a>
      </nav>
    </div>
  </div>
  <div class="main">
